...
func (s *Sqlite) CreateStudent(storage storage.Storage, name string, email string, age int) (int64, error) {
...
func (s *Sqlite) GetStudentById(id int64) (types.Student, error) {
	...
	if err != nil {
		if err == sql.ErrNoRows {
			return types.Student{}, fmt.Errorf("student not found: %s", fmt.Sprint(id))
		}
